    ...
    return (
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-1 my-4">
            ...
            <div className="col-span-2 flex items-center justify-between space-x-2">
                ...
                readOnly
                className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-black dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500 "
                placeholder=""
                required
                />

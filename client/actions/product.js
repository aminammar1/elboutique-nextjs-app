  ...
  export const getProductByCategoryID = async (categoryId) => {
    try {
      const response = await axios.get(
        `${API_URL}/api/products/get-product-bycategoryId/${categoryId}`,
        { withCredentials: true }
      )
      ...
      throw new Error(
        error.response?.data?.message || 'Failed to fetch products by category ID'
      )
    }
  }
  ...
  export const getProductBySubcategoryID = async (subcategoryId) => {
    try {
      const response = await axios.get(
        `${API_URL}/api/products/get-product-bysubcategoryId/${subcategoryId}`,
        { withCredentials: true }
      )
      return response.data.data
    } catch (error) {
      throw new Error(
        error.response?.data?.message ||
          'Failed to fetch products by subcategory ID'
      )
    }
  }
  ...
  export const getProductByPriceRange = async (minPrice, maxPrice) => {
    try {
      const response = await axios.get(
        `${API_URL}/api/products/get-products-by-price-range`,
        {
      ...
      throw new Error(
        error.response?.data?.message || 'Failed to fetch products by price range'
      )
    }
  }
  ...
  export const fetchFilteredProducts = async (filter, perPage, page) => {
